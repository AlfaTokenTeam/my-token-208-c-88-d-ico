...
import "./MyToken208C88D.sol";

contract MyToken208C88DPreSale {
    MyToken208C88D public token;
    ...
    function MyToken208C88DPreSale(
        MyToken208C88D _token,
        address _beneficiary,
        uint _bonus
    ) {
        token = MyToken208C88D(_token);
